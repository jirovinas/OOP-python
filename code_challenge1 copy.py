...
while True:
    ...
    if choice == 1:
        ...
        for book in library:
            if book.title == title:
                # Ito kanina nakalagay Librarian dapat gawa ka muna ng instance ng Librarian
                # Librarian.remove_book(book)
                goku_the_librarian.remove_book(book)
        ...
        for book in goku_the_librarian.check_books_available(library):
            print(book.title)
